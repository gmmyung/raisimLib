...
from raisimGymTorch.stable_baselines3.RaisimSbGymVecEnv import (
    RaisimSbGymVecEnv as VecEnv,
)
...
env = VecEnv(
    rsg_anymal.RaisimGymEnv(rsc_path, dump(cfg["environment"], Dumper=RoundTripDumper)),
    normalize_ob=True,
)
obs = env.reset()
